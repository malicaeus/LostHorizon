...
import net.mcreator.losthorizon.potion.KnockbackResistanceMobEffect;
...
public class LosthorizonModMobEffects {
	...
	public static final DeferredHolder<MobEffect, MobEffect> KNOCKBACK_RESISTANCE = REGISTRY.register("knockback_resistance", () -> new KnockbackResistanceMobEffect());
}