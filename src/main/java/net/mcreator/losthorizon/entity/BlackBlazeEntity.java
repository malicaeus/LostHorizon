...
public class BlackBlazeEntity extends Blaze implements RangedAttackMob {
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(serverLevel, new ItemStack(LosthorizonModItems.ASH_OF_DAWN.get()));
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(LosthorizonModEntities.BLACK_BLAZE.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
